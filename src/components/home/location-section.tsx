...
const MapClient = dynamic(() => import('./map-client'), { ssr: false }) as React.ComponentType<{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <Card className="overflow-hidden shadow-lg">
            <CardContent className="p-0">
              <MapClient locations={locations} height="400px" className="rounded-lg overflow-hidden" />
            </CardContent>
          </Card>
        </div>
      </div>
